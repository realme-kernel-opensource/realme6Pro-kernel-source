...
/* add begin by zhangchaofan@ODM_LQ@Multimedia.TP for kernel symbol, 2019/11/05*/
EXPORT_SYMBOL(register_device_proc);
/* add end by zhangchaofan@ODM_LQ@Multimedia.TP for kernel symbol, 2019/11/05 */
