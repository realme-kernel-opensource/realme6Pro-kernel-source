...
#define NVT_TOUCH_ESD_DISP_RECOVERY (1) /* add  by zhangchaofan@ODM_LQ@Multimedia.TP, for tp esd 2019-12-02*/
#define NVT_PM_WAIT_SPI_RESUME_COMPLETION (1) /* add for wait spi when pm resume by qujiong@ODM_LQ@BSP.TP,2020-01-03*/
