...
#include <linux/regulator/consumer.h>	//add  by zhangchaofan@ODM_LQ@Multimedia.TP, 2019-11-06
...
/* add begin by zhangchaofan@ODM_LQ@Multimedia.TP for ibb lab vddio, 2019-11-06*/
//#define NVT_SPI_VTG_MIN_UV                  1800000
//#define NVT_SPI_VTG_MAX_UV                  1800000
//#define NVT_lab_VTG_MIN_UV                  4600000
//#define NVT_lab_VTG_MAX_UV                  6000000
//#define NVT_ibb_VTG_MIN_UV                  4600000
//#define NVT_ibb_VTG_MAX_UV                  6000000
/* add end by zhangchaofan@ODM_LQ@Multimedia.TP for ibb lab vddio, 2019-11-06 */
...
/* add begin by zhangchaofan@ODM_LQ@Multimedia.TP for ibb lab vddio, 2019-11-06*/
//	struct regulator *pwr_vdd; /* vddio 1.8V */
...
struct touchpanel_data {
	...
	bool dev_pm_suspend;                                /* flag for pm suspend add by qujiong@ODM_LQ@BSP.TP,2020-01-03*/
	...
	struct completion      dev_pm_resume_complete;      /*completion for pm resume add by qujiong@ODM_LQ@BSP.TP,2020-01-03*/
    ...
    struct delayed_work     lcd_trigger_load_tp_fw_work;  /*trigger load tp fw by lcd driver after lcd reset*/
