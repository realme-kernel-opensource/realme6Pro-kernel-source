...
static const char * const fw_path[] = {
	...
	/* CONFIG_SND_SOC_AWINIC_AW882XX */
	"/vendor/firmware/awinic",
	/* modify by zhangchaofan@ODM_LQ@Multimedia.TP, add tp fw path 2019-11-14 */
	"/vendor/firmware/tp",
	#endif /*ODM_LQ_EDIT*/
...
#ifdef VENDOR_EDIT
//ZhongWenjie@Bsp.Group.Tp, 2019-04-26, dd to avoid direct pass encrypt tp firmware to driver
...
#ifdef VENDOR_EDIT
	//ZhongWenjie@Bsp.Group.Tp, 2019-04-26, Add to avoid direct pass encrypt tp firmware to driver
