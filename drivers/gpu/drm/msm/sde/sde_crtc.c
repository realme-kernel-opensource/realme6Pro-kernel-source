		...
		struct drm_crtc_state *old_crtc_state)
{
	...
	//#ifdef ODM_LQ_EDIT
	/*xuchengxin@ODM_LQ@Multimedia.Dispaly,2020/1/14,Solving sliding stutter issues */
...
static void sde_crtc_disable(struct drm_crtc *crtc)
{
	...
	//#ifdef ODM_LQ_EDIT
	/*xuchengxin@ODM_LQ@Multimedia.Dispaly,2020/1/10,Solving sliding stutter issues */
	_sde_crtc_flush_event_thread(crtc);
	//#endif /*ODM_LQ_EDIT*/
	mutex_lock(&sde_crtc->crtc_lock);
	SDE_EVT32_VERBOSE(DRMID(crtc));
