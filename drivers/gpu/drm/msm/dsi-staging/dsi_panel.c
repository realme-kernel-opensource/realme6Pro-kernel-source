...
#ifdef ODM_LQ_EDIT
	/* modify begin by zhangchaofan@ODM_LQ@Multimedia.LCD, lcd esd power off delay 20ms 2019-12-05 */
	if (tp_gesture_esd_flag)
		mdelay(10);
	/* modify end by zhangchaofan@ODM_LQ@Multimedia.LCD, lcd esd power off delay 20ms 2019-12-05 */
#endif /*ODM_LQ_EDIT*/
...
#ifdef ODM_LQ_EDIT
/* modify begin by zhangchaofan@ODM_LQ@Multimedia.TP, add tp esd flag 2019-12-05 */
	if (atomic_read(&panel->esd_recovery_pending))
		tp_gesture_esd_flag = true;
	else
		tp_gesture_esd_flag = false;
/* modify end by zhangchaofan@ODM_LQ@Multimedia.TP, add tp esd flag 2019-12-05 */
#endif /*ODM_LQ_EDIT*/
	if (!atomic_read(&panel->esd_recovery_pending)) {
		/*
