...
**    Modify for vooc batt 4.40   */
	...
	switch (chip->vooc_fw_type) {
		...
		case VOOC_FW_TYPE_STM8S_4450_FFC_5V6A_VOOC_4052MA_3BIT:
			...
			break;
		case VOOC_FW_TYPE_STM8S_4450_FFC_5V6A_VOOC_19551:
			chip->firmware_data = Stm8s_fw_data_4450_ffc_5v6a_19551;
			chip->fw_data_count = sizeof(Stm8s_fw_data_4450_ffc_5v6a_19551);
			chip->fw_data_version = Stm8s_fw_data_4450_ffc_5v6a_19551[chip->fw_data_count - 4];
			break;
